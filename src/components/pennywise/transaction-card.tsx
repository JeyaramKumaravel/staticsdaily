            ...
            <CardTitle className="text-base md:text-md font-semibold text-foreground">
              {isIncome && (
                <span className="flex items-center min-w-0">
                  ...
                  <span className="truncate">{incomeData.source.charAt(0).toUpperCase() + incomeData.source.slice(1)}</span>
                </span>
              )}
              {isExpense && (
                <span className="flex items-center min-w-0">
              ...
              {isTransfer && (
                <span className="flex items-center min-w-0">
                  ...
                  <span className="truncate">Transfer: {transferData.fromSource.charAt(0).toUpperCase() + transferData.fromSource.slice(1)}</span>
                  <ArrowRightLeft className="mx-1 h-3 w-3 text-muted-foreground flex-shrink-0" />
                  <span className="truncate">{transferData.toSource.charAt(0).toUpperCase() + transferData.toSource.slice(1)}</span>
                </span>
              )}
              {isDebt && (
                <span className="flex items-center min-w-0">
                  ...
                  <span className="text-xs text-muted-foreground ml-1.5 font-normal">({debtData.source})</span>
                </span>
              )}
            </CardTitle>
            {onDateClick ? (
